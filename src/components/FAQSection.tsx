		...
		<div
			...
			<div
				...
				<div className="flex items-center justify-between p-6 md:p-8 relative z-10">
					<h3 className="text-[18px] md:text-[20px] font-bold text-white pr-8 leading-snug geist">
						{faq.question}
					</h3>
				...
				<div
					...
					/>
					<p className="px-6 md:px-8 py-6 text-gray-300 leading-relaxed text-[16px] geist">
						{faq.answer}
					</p>
				</div>
			</div>
		...
		<div className="bg-[#050505] py-24 border-t border-white/5">
			<div className="max-w-[900px] mx-auto px-6">
				...
				<div className="text-center mb-16">
					<h2 className="nohemi text-[32px] lg:text-[56px] font-display font-medium text-white mb-4 tracking-tight leading-[1.2]">
						Most asked questions
					</h2>
					<p className="geist text-gray-400 text-sm md:text-base">
