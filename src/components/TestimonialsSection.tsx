...
const TestimonialsSection: React.FC = () => {
	...
	return (
    <div className="bg-[#050505] py-15 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-0 relative z-10">
        ...
        <div className="text-center mb-16 relative">
          <h2 className="text-[32px] lg:text-[56px] nohemi font-medium text-white tracking-tight leading-[1.2]">
            See what our
            <br />
            <span className="text-[#1CFA76] relative inline-block mx-2">
              happy clients
            </span>{" "}
            are saying
          </h2>
        ...
        {/* Testimonial Card */}
        <div className="bg-[#0A0A0A] border border-white/10 rounded-[40px] p-4 md:p-6 lg:p-8 flex flex-col md:flex-row gap-8 md:gap-12 relative overflow-hidden geist">
          ...
          <div className="flex-1 flex flex-col justify-center py-4 pr-4 md:pr-8">
            <blockquote className="text-[20px] md:text-[24px] font-sans text-[#EDEDED] leading-[1.6] mb-10 geist">
              "{current.quote}"
            </blockquote>
        ...
        <div className="flex justify-center gap-2 mt-8 geist">
        ...
        {/* Stats Row */}
        <div className="grid geist grid-cols-2 md:grid-cols-4 gap-8 mt-20 text-center border-t border-white/5 pt-12">
          <div>
