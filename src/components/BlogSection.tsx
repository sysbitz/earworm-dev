	...
	return (
		   <div
			...
			<div className="flex flex-col items-start grow px-2 pb-2 relative z-10">
				...
				<h3 className="text-[20px] md:text-[24px] font-display font-bold text-white leading-tight mb-4 transition-colors geist">
					{post.title}
				</h3>

				<div className="mt-auto pt-2">
					<div
						className="flex items-center font-bold text-sm group/link transition-colors duration-300 geist"
						style={{
...
const ViewAllButton: React.FC = () => {
	...
	return (
		<button
			...
			<span
				className="mr-4 text-sm font-display tracking-wide relative z-10 transition-colors duration-300 geist"
				style={{
...
const BlogSection: React.FC = () => {
	return (
		<div className="bg-[#0D0D0D] py-24 relative z-10">
