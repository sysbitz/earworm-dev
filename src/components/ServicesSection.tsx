		...
		<div className="bg-[#E4E5E9] border border-t py-[60px] relative z-0">
			<div className="max-w-[1280px] mx-auto px-4 lg:px-0">
				...
				<div className="flex flex-col lg:flex-row justify-between items-start mb-16 gap-8">
					<h2 className="nohemi text-[32px] lg:text-[56px] font-display font-semibold text-[#0A0A0A] tracking-tight leading-[1.2]">
						Our Services
					</h2>
					<p className="text-[#4A4A4A] leading-[1.5] max-w-xl text-xl geist">
				...
				<div className="relative mb-6 p-8" style={glassStyle}>
					<div className="rounded-[24px] bg-white overflow-hidden flex flex-col md:flex-row min-h-[500px] p-8">
						...
						<div className="md:w-1/2 p-6 md:p-10 lg:p-12 flex flex-col justify-center">
							...
							<div>
								<button className="relative px-6 py-2.5 rounded-full font-bold text-[15px] text-[#0A0A0A] flex items-center gap-3 shadow-[0_4px_16px_rgba(0,0,0,0.08)] hover:shadow-[0_8px_24px_rgba(28,249,117,0.35)] transition-shadow duration-300 overflow-hidden bg-white group geist">
									<span
				...
				<div className="relative mb-6 p-8" style={glassStyle}>
					<div className="rounded-[24px] bg-white overflow-hidden flex flex-col md:flex-row min-h-[500px] p-8">
						...
						<div className="md:w-1/2 p-10 md:p-14 lg:p-16 flex flex-col justify-center">
							<h3 className="text-[40px] font-display font-bold text-[#0A0A0A] mb-4 leading-[1.5] geist">
								Run & Scale
							</h3>
							<h4 className="text-[24px] font-medium text-[#373737] mb-6 geist">
							...
							<p className="text-gray-500 text-[20px] leading-[1.5] mb-10 geist">
