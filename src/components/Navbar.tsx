          ...
          <div className="flex items-center justify-between h-12">
            ...
            <div className="hidden lg:flex items-center justify-center flex-1">
              <div className="flex items-center space-x-1">
                ...
                >
                  <button className="flex items-center text-white hover:bg-white/10 rounded-full px-4 py-2 text-[16px] font-medium transition-all whitespace-nowrap">
                    Our service{" "}
                    <ChevronDown
                ...
                >
                  <button
                    className={`flex items-center text-white rounded-full px-4 py-2 text-[16px] font-medium transition-all whitespace-nowrap ${isResourcesDropdownOpen ? "bg-white/20" : "hover:bg-white/10"}`}
                  >
                    Resources{" "}
                    <ChevronDown
                ...
                <a
                  href="#"
                  className="text-white hover:bg-white/10 rounded-full px-4 py-2 text-[16px] font-medium transition-all whitespace-nowrap"
                >
                  Case Studies
                </a>
                <a
            ...
            <div className="hidden lg:flex items-center space-x-6 pl-4">
              <a
                href="#"
                className="text-white hover:text-white text-[16px] font-medium transition-colors whitespace-nowrap"
              >
                Client Portal
              </a>
              <button className="bg-[#6359EA] hover:bg-[#5558DD] text-white px-7 py-2.5 rounded-[31px] text-[16px] font-medium transition-all shadow-lg shadow-indigo-500/20 whitespace-nowrap">
                Lets Talk
              </button>
            </div>
