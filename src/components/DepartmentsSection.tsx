				...
				<div className="px-2 lg:px-2 w-full">
					...
					<div
						...
						<div
							...
							{/* Left Side: Tabs */}
							<div className="lg:w-[70%] p-6 lg:p-8 flex flex-col justify-center">
									...
									{departments.map((dept, index) => {
										...
										return (
											<div
												...
												className="cursor-pointer transition-all duration-300 py-3">
												<div className="flex items-start gap-4 md:gap-5">
													...
													<div className="flex-1">
														<div className="flex items-center gap-4 mb-3">
															...
															<h3
																className={`text-[28px] geist font-semibold font-display tracking-tight ${
														...
														<div
															...
															<div className="overflow-hidden">
																<p className="text-[#373737] geist text-[18px] leading-relaxed pl-12 pb-1">
																	{dept.description}
																</p>
															</div>
														</div>
												...
												{!isActive && (
													<div className="ml-12 mt-3 h-px bg-gray-100"></div>
												)}
											</div>
										);
									})}
