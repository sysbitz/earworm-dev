		...
		<div className="bg-[#E6E8EB] pt-[100px] pb-12 -mt-20 relative z-10">
			<div className="max-w-[1280px] mx-auto px-2 lg:px-2">
				...
				<div className="mb-8 text-center">
					<h2 className="nohemi text-[32px] lg:text-[56px] font-display font-medium text-[#0A0A0A] mb-4 tracking-tight leading-[1.2] geist">
						Video content that supports <br />
						your entire organisation
					</h2>
					<p className="text-[#4A4A4A] text-[18px] leading-[1.5] max-w-2xl mx-auto geist">
											...
											<div className="flex items-start gap-4 md:gap-6">
												...
												<div className="flex-1">
													<div className="flex items-center gap-4 mb-3">
														...
														<h3
														   className={`text-[28px] font-bold font-display tracking-tight geist ${
													...
													<div
														...
														<div className="overflow-hidden">
															<p className="text-[#4A4A4A] text-[16px] leading-relaxed pl-[56px] pb-1 geist">
																{dept.description}
															</p>
														</div>
													</div>
