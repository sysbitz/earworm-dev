  ...
  return (
    <div className="bg-[#050505] py-24 relative overflow-hidden">
      ...
      <div className="text-center max-w-4xl mx-auto px-6 mb-16 relative z-10">
        <h2 className="nohemi text-[32px] lg:text-[56px] font-display font-medium text-white mb-6 tracking-tight leading-[1.2]">
            Access to an industry <br />
            leading production planner
        </h2>
        <p className="geist text-gray-400 text-[20px] leading-[1.5] max-w-2xl mx-auto">
