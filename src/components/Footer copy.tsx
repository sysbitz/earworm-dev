			...
			<div className="max-w-[1280px] mx-auto">
				...
				<div className="flex flex-col lg:flex-row justify-between gap-16 lg:gap-40 mb-20">
					...
					<div>
						...
						<p className="text-gray-400 text-[20px] leading-[1.5] mb-10 max-w-md pb-10 geist">
							...
							<div className="relative max-w-md">
								...
								>
									<input
										...
										required
									/>
									<button type="submit" className="absolute right-1.5 top-1.5 bottom-1.5 bg-white text-black font-bold rounded-full px-6 text-xs hover:bg-gray-200 transition-colors uppercase geist">
										Subscribe
									</button>
								</form>
					...
					<div className=" flex flex-col md:flex-row gap-8 lg:gap-20 ">
						{/* Info & Links */}
						<div>
							<h4 className="text-white font-medium text-[16px] mb-4 uppercase tracking-wider geist">
								Info & Links
							</h4>
							<ul className="space-y-4 text-gray-400 text-[16px] geist">
								<li>
