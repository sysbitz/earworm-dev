	...
	return (
		<div className="bg-[#050505] py-24 relative overflow-hidden">
			<div className="max-w-[1200px] mx-auto px-6 relative z-10">
				...
				{/* Steps Grid */}
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-0" style={{ marginTop: '40px' }}>
					<StepCard
						icon={
							<img
...
{/* Calendar Embed */}
<div
	className="relative z-10 max-w-[1280px] mx-auto flex flex-col items-start gap-[10px] py-[60px] pl-[18px] pr-[12px] mt-0"
>
  <CalendarWidget />
</div>
