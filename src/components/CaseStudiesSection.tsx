		...
		<div
			...
			<div className="absolute bottom-0 left-0 right-0 z-10">
				...
				<div className="relative p-5">
					<h3 className="text-[22px] font-display font-bold text-white mb-2 tracking-wide geist">
						{study.title}
					</h3>

					<p className="text-gray-400 text-[14px] leading-relaxed mb-4 line-clamp-3 geist">
						Body text describing the services offered in a summary. Body text
						describing the service
					</p>

					<div className="flex justify-end">
						<div className="w-8 h-8 rounded-full bg-white text-black flex items-center justify-center transition-all duration-300 group-hover:scale-110 group-hover:bg-[#8266FF] group-hover:text-white">
...
const CaseStudiesSection: React.FC = () => {
	...
	return (
		<div
			className="bg-[#0A0A0A] pt-24 pb-24 relative z-20"
			...
			/>
			<div className="max-w-[1600px] mx-auto px-8 lg:px-20 xl:px-28 relative z-10">
				{/* Header */}
				<div className="flex flex-row justify-between items-end mb-16">
					<div>
						<h2 className="text-[32px] lg:text-[48px] font-display font-medium text-white mb-3 tracking-tight leading-[1.2] nohemi">
							Case studies
						</h2>
						<p className="text-gray-500 text-[16px] leading-[1.5] geist">
							We've launched hundreds of shows and measured the impact
						</p>
					</div>

					<div
						className="relative group p-[1px] rounded-full"
						style={{
							background:
            ...
            ">
							<span className="font-medium text-sm relative z-10 geist">
								View All Work
							</span>
							<ArrowUpRight className="w-4 h-4 relative z-10 transition-all duration-300 group-hover:rotate-45 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
						</button>
					</div>
				</div>
