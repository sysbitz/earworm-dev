...
const StatCard: React.FC<StatCardProps> = ({
    ...
    <div
      ...
      style={{
        background:
          "linear-gradient(160deg, rgba(255,255,255,0.09) 0%, rgba(255,255,255,0.02) 30%, rgba(0,0,0,0.5) 100%)",
        boxShadow:
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent 0%, rgba(255,255,255,0.5) 40%, rgba(255,255,255,0.2) 60%, transparent 100%)",
        }}
      />
      ...
      <h3 className="max-w-72 lg:text-[32px] text-white mb-28 relative z-10 font-semibold leading-tight tracking-wide geist">
        {title}
      </h3>
      ...
      <div className="relative z-10 flex flex-col h-full">
        <div className="flex items-center mb-4 relative">
          <span
            className="text-6xl md:text-7xl lg:text-[5rem] font-bold tracking-tighter leading-none inline-block geist"
            style={{
              background:
        ...
        <p className="text-[#E0E0E0] text-[20px] mb-10 leading-normal font-normal geist">
          {description}
        </p>

        {/* Push to bottom */}
        <div className="mt-auto">
          <div className="w-8.5 border-t border-[#969696] mb-5"></div>
          <p className="text-[#969696] text-[16px] geist">{source}</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="bg-[#0D0D0D] py-15 px-20 relative z-10">
      <div className="max-w-360 mx-auto px-6 lg:px-0">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start mb-16 gap-10">
          ...
          <p className="text-[#E0E0E0] text-[20px] leading-normal max-w-100 lg:text-left geist">
