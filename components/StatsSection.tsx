...
const StatCard: React.FC<StatCardProps> = ({
  ...
  return (
    <div
      ...
      className="bg-[#0A0A0A] border border-white/10 rounded-[24px] p-8 md:p-[40px] flex flex-col h-full relative overflow-hidden group hover:border-white/20 transition-all duration-300"
    >
      {/* Top Glow Effect */}
      <div
      ...
      <h3 className="max-w-72 lg:text-[32px] font-sans text-white mb-[100px] relative z-10 font-semibold leading-tight tracking-wide">
        {title}
      </h3>
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <p className="text-gray-300 text-[20px] mb-[40px] leading-[1.5] font-sans font-normal">
          {description}
        </p>
        ...
        <div className="mt-auto">
          ...
          <p className="text-gray-500 font-sans">{source}</p>
        </div>
      </div>
    </div>
  );
...
const StatsSection: React.FC = () => {
  return (
    <div className="bg-brand-black pt-[60px] relative z-10">
      <div className="max-w-[1280px] mx-auto px-6 lg:px-0">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start mb-[64px] gap-10">
          ...
          <p className="text-gray-400 text-[20px] leading-[1.5] max-w-[450px] lg:text-left">
