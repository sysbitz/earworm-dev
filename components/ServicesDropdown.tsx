...
const ServicesDropdown: React.FC<ServicesDropdownProps> = ({ isOpen }) => {
  ...
  return (
    <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-3 bg-gradient-to-b from-[#0F0F0F]/95 to-[#0F0F0F]/80 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl shadow-black/50 p-8 z-50 overflow-hidden" style={{ width: '920px' }}>
      ...
      <div className="grid grid-cols-3 gap-6 relative z-10">
        ...
        <div className="border border-white/10 rounded-2xl bg-gradient-to-br from-white/5 to-transparent p-6 flex flex-col justify-between">
          <div>
            ...
            <p className="text-sm text-gray-300 mb-6 leading-relaxed">
              We incubate, design, and launch podcasts that help businesses lead conversations
            </p>
        ...
        <div className="border border-white/10 rounded-2xl bg-gradient-to-br from-white/5 to-transparent p-6 flex flex-col">
          ...
          <p className="text-sm text-gray-300 mb-4 leading-relaxed">
            We manage your podcast end-to-end, turning each episode into a consistent, measurable growth channel.
          </p>
        ...
        {/* Right Column - Services List with Main Image */}
        <div className="flex flex-col justify-between">
          ...
          <div className="space-y-4 mb-4">
            ...
            <div className="flex items-start space-x-3 p-3 rounded-lg hover:bg-white/5 transition-colors cursor-pointer">
              ...
              <div>
                <h4 className="text-sm font-semibold text-white">Strategy & Planning</h4>
                <p className="text-xs text-gray-400 mt-1">Podcast strategy • Episode planning • Research: Guest sourcing</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3 p-3 rounded-lg hover:bg-white/5 transition-colors cursor-pointer">
              ...
              <div>
                <h4 className="text-sm font-semibold text-white">Production & Creative</h4>
                <p className="text-xs text-gray-400 mt-1">Video & audio production • Graphic design • Motion graphics</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3 p-3 rounded-lg hover:bg-white/5 transition-colors cursor-pointer">
              ...
              <div>
                <h4 className="text-sm font-semibold text-white">Distribution & Insight</h4>
                <p className="text-xs text-gray-400 mt-1">Publishing & distribution • Analytics & reporting • Audience insights</p>
              </div>
            </div>
          </div>
