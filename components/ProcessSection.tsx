...
const ProcessSection: React.FC = () => {
  ...
  return (
    <div className="bg-brand-black py-[60px] relative rounded-b-[60px] lg:rounded-b-[80px] z-20">
      <div className="max-w-[1280px] mx-auto px-6 lg:px-0 relative z-10">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          <div className="lg:sticky lg:top-32 self-start">
            ...
            <p className="text-gray-400 text-[20px] leading-[1.5] mb-16 max-w-2xl text-justify">
          ...
          <div className="lg:w-2/3 flex flex-col gap-5 mb-14">
