  ...
  const resources = [
    {
      ...
      description: "We're diving the shift from written content to video—it means for brands.",
    ...
    },
    {
      ...
      description: "We'd be mad to ignore video and when they need video as an afterthought.",
      image: "/face (1).png"
    },
    {
      id: 4,
      title: "Building businesses - and partnerships - that last",
      description: "What sustainable growth and delivery looks like when quality and trust actually matter.",
      image: "/face (2).png"
    }
  ];

  return (
    <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-3 bg-gradient-to-b from-[#0F0F0F]/95 to-[#0F0F0F]/80 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl shadow-black/50 p-8 z-50 overflow-hidden" style={{ width: '992px' }}>
