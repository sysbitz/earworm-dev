...
const DepartmentsSection: React.FC = () => {
  ...
  // Handle mouse wheel scroll with cooldown
  useEffect(() => {
  ...
  return (
    <div className="bg-[#E6E8EB] pt-32 pb-24 -mt-20 relative z-10">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        {/* Main Content Card */}
        <div className="bg-white rounded-[40px] shadow-2xl shadow-black/5 overflow-hidden flex flex-col lg:flex-row min-h-[600px] transition-all duration-500 ease-in-out">
          {/* Left Side: Tabs */}
              ...
              {departments.map((dept, index) => {
                ...
                return (
                  ...
                  >
                        ...
                        <div className="flex items-center gap-4 mb-3">
                          <div
                            className={`w-10 h-10 rounded-full flex items-center justify-center transition-colors duration-300 ${
                              isActive ? 'bg-[#F3F4F6] text-black' : 'bg-transparent text-gray-600'
                            }`}
                          >
                            {dept.icon}
                          </div>
                    ...
                    {!isActive && <div className="ml-[60px] mt-4 h-px bg-gray-100"></div>}
                  </div>
                );
              })}
            </div>
