...
const AnimatedStat: React.FC<AnimatedStatProps> = ({
	...
	return (
		<div
			ref={ref}
			className="text-3xl md:text-[40px] font-display font-bold text-white mb-2 leading-[1.5]">
			{prefix}
			{displayValue}
			{suffix}
		</div>
		...
		<div className="bg-[#050505] py-24 relative overflow-hidden">
			...
			<div className="max-w-[1200px] mx-auto px-6 lg:px-12 relative z-10">
				...
				<div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-20 text-center border-t border-white/5 pt-12">
					<div>
						<AnimatedStat value="$5bn+" isAnimated={true} />
						<div className="text-gray-500 text-[16px]">
							In yearly card spend
						</div>
					</div>
					<div>
						<AnimatedStat value="4m+" isAnimated={true} />
						<div className="text-gray-500 text-[16px]">Virtual card issued</div>
					</div>
					<div>
						<AnimatedStat value="3k+" isAnimated={true} />
						<div className="text-gray-500 text-[16px]">Happy customers</div>
					</div>
					<div className="relative">
						<AnimatedStat value="$100m+" isAnimated={true} />
