...
const StepCard: React.FC<{
	...
	<div
		...
		<div className="relative z-10 flex items-center gap-4 mb-6">
			...
			<h3 className="text-[22px] font-bold text-white font-display tracking-tight">
				{title}
			</h3>
		</div>

		<p className="relative z-10 text-gray-400 text-[16px] leading-relaxed group-hover:text-gray-300 transition-colors">
			{description}
		</p>
	</div>
);
		...
		<div className="bg-white rounded-[32px] overflow-hidden flex flex-col w-full max-w-[1000px] mx-auto shadow-2xl text-black">
			<div className="flex flex-col lg:flex-row">
				...
				<div className="p-8 lg:p-10 border-b lg:border-b-0 lg:border-r border-gray-100 lg:w-[35%] bg-gray-50/50">
					...
					<h3 className="text-gray-500 font-bold mb-1 text-sm">
						Project Discovery with
					</h3>
					<h2 className="text-2xl font-black mb-6 flex items-center gap-2 font-display">
