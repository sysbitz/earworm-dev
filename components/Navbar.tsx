...
const Navbar: React.FC = () => {
  ...
  return (
    <div className="fixed w-full z-50 top-6 px-4 pointer-events-none">
      <nav className="max-w-[1280px] w-full mx-auto bg-white/[0.05] backdrop-blur-md border border-white/10 rounded-full pl-[18px] p-3 relative pointer-events-auto shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] overflow-visible">
        <div className="flex items-center justify-between h-12">
          ...
          <div className="hidden lg:flex items-center space-x-6 pl-4">
            ...
            <button className="bg-[#6359EA] hover:bg-[#5558DD] text-white px-7 py-2.5 rounded-full text-[15px] font-medium transition-all shadow-lg shadow-indigo-500/20 whitespace-nowrap">
              Lets Talk
            </button>
          </div>
