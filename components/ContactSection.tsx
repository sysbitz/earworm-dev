						...
						<div className="mb-12">
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
								{[
									...
									<div key={idx}>
										<label className="block text-[14px] text-gray-500 mb-2 pl-1 font-medium">
											{field.label}
										</label>
										<div className="relative">
											<select
												...
												className="w-full bg-[#111] border border-white/10 rounded-xl px-4 py-3.5 text-white appearance-none focus:outline-none focus:border-brand-green/50 transition-colors cursor-pointer text-[16px]">
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
								<div>
									...
									<input
										...
										className="w-full bg-[#111] border border-white/10 rounded-xl px-4 py-3.5 text-white placeholder-gray-600 focus:outline-none focus:border-brand-green/50 transition-colors text-[16px]"
									/>
								</div>
								<div>
									<label className="block text-[14px] text-gray-500 mb-2 pl-1 font-medium">
							...
							<div className="space-y-6">
								...
								<div>
									...
									<textarea
										...
										rows={4}
										className="w-full bg-[#111] border border-white/10 rounded-xl px-4 py-3.5 text-white placeholder-gray-600 focus:outline-none focus:border-brand-green/50 resize-none transition-colors text-[16px]"
									/>
								</div>
							</div>
						</div>
